...
export default function GameModeSelection({ onModeSelect, onBack, mainVolume = 1, uiSound = 1 }: GameModeSelectionProps) {
  const gameModes = [
    ...
    },
    {
      ...
      img: '/assets/Menu-Background/Assets/tournament_card.png',
      alt: 'Tournament Mode',
    },
    {
      id: 'ai' as GameMode,
    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-8">
      ...
      <div className="max-w-4xl w-full relative z-20">
        ...
        <div className="text-center mb-12">
          <img src="/assets/Menu-Background/Assets/Choose_battle.png" alt="Choose Battle" className="mx-auto mb-4 max-w-[600px] w-[90vw] drop-shadow-2xl" />
        </div>
        {/* Game Mode Cards */}
        ...
        <div className="text-center">
          <SoundButton
            onClick={onBack}
            className="group flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-110 focus:outline-none bg-transparent shadow-none"
